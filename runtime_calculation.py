...
if __name__ == "__main__":
    ...
    CPU_year, CPU_year_sp, co_cost_rate, co_cost_rate_sp = cal_cost_overall_700yr_new_timing_model(
        fmin, fmax, fdotmin, fdotmax, fsp, fdotsp, fband_cell, fdotband_cell,
        m0, m1, m2, r1, r2, Tcoh_day, nSFT, nSeg, tau, n, fbandwidth)
    
    print(f"总CPU年数: {CPU_year_sp:.2e}")
    print(f"相干成本率: {co_cost_rate:.2e}")
    print(f"网格大小: {CPU_year.shape}")